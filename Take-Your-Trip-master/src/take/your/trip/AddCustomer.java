...
public class AddCustomer extends JFrame {
	...
	public AddCustomer(String username) throws SQLException {
		//System.out.println(username);
                setBounds(250, 50, 880, 550);
		contentPane = new JPanel();
		setContentPane(contentPane);
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("take/your/trip/icons/newcustomer.jpg"));
        ...
        Image bgi = bg.getImage().getScaledInstance(850, 550, Image.SCALE_DEFAULT);
        ImageIcon bgi2 = new ImageIcon(bgi);

        JLabel lbg = new JLabel(bgi2);
        lbg.setBounds(0, 0, 850, 550);
        contentPane.add(lbg);
