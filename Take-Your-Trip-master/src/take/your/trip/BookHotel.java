...
public class BookHotel extends JFrame {
	...
	public BookHotel(String username) {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("take/your/trip/hotels/Agra_h.jpg"));
		...
		JLabel la6 = new JLabel("is_Double-Bed :");
			...
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                if(rs.next()){
                                    ...
                                    int food = Integer.parseInt(rs.getString("dbed"));
        ...
        Image bgi = bg.getImage().getScaledInstance(1100, 600, Image.SCALE_DEFAULT);
        ImageIcon bgi2 = new ImageIcon(bgi);

        JLabel lbg = new JLabel(bgi2);
        lbg.setBounds(0, 0, 1100, 600);
       contentPane.add(lbg);
