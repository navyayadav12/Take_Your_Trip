...
public class ViewPackage extends JFrame {
	...
	public ViewPackage(String username)  {
		setBounds(250, 50, 850, 450);
		contentPane = new JPanel();
		setContentPane(contentPane);
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("take/your/trip/icons/bookedDetails.jpg"));
        ...
        Image bgi = bg.getImage().getScaledInstance(850, 450, Image.SCALE_DEFAULT);
        ImageIcon bgi2 = new ImageIcon(bgi);

        JLabel lbg = new JLabel(bgi2);
        lbg.setBounds(0, 0, 850, 450);
        contentPane.add(lbg);
