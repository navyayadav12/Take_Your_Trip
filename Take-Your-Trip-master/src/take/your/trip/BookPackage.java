...
public class BookPackage extends JFrame {
	...
	public BookPackage(String username) {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("take/your/trip/icons/bookpackage.jpg"));
                Image i3 = i1.getImage().getScaledInstance(400, 300,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel la1 = new JLabel(i2);
                la1.setBounds(550,50,400,300);
                add(la1);
        ...
        Image bgi = bg.getImage().getScaledInstance(1000, 450, Image.SCALE_DEFAULT);
        ImageIcon bgi2 = new ImageIcon(bgi);

        JLabel lbg = new JLabel(bgi2);
        lbg.setBounds(0, 0, 1000, 450);
        contentPane.add(lbg);
