...
public class UpdateCustomer extends JFrame {
	...
	public UpdateCustomer(String username) throws SQLException {
		System.out.println(username);
                setBounds(250, 50, 800, 550);
		contentPane = new JPanel();
		setContentPane(contentPane);
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("take/your/trip/icons/update.png"));
        ...
        Image bgi = bg.getImage().getScaledInstance(800, 550, Image.SCALE_DEFAULT);
        ImageIcon bgi2 = new ImageIcon(bgi);

        JLabel lbg = new JLabel(bgi2);
        lbg.setBounds(0, 0, 800, 550);
        contentPane.add(lbg);
