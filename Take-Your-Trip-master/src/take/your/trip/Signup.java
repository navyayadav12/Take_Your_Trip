...
public class Signup extends JFrame implements ActionListener {
    ...
    public Signup() {
        ...
        ImageIcon c1 = new ImageIcon(ClassLoader.getSystemResource("take/your/trip/icons/signup.png"));
    ...
    public void actionPerformed(ActionEvent ae) {// abtract method of ActionListener interface
        try {
            Conn con = new Conn();
